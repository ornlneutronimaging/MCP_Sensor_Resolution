...
#establish prefix for files
    ...
    def run_fit (zones:np.ndarray, y1:int, left_lat_lim:int, right_lat_lim:int, normalized_image_file:str)->str:
        ...
        -------
        str
            Print statements detailing the data sample size, average resolution and spatial resolution of the sensor, and the standard deviation of the data set as a 
            measure of the strength of the data correlation 
        """
